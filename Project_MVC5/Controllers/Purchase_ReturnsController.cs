...
{
    public class Purchase_ReturnsController : Controller
    {
       WICKRAMA_STORESEntities db = new WICKRAMA_STORESEntities();
        ...
        public ActionResult AddorEdit(tb_PurchaseReturns model)
        {
            tb_PurchaseReturns toDB = new tb_PurchaseReturns();
            ...
            db.tb_PurchaseReturns.Add(toDB);
            db.SaveChanges();
